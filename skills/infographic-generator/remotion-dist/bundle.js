...
var esm = __webpack_require__(2053);
...
;// ./src/templates/Knowledge.tsx




const KnowledgeTemplate = ({ config }) => {
...
;// ./src/templates/Xiaohongshu.tsx

const XiaohongshuTemplate = ({ config }) => {
  const { content, style } = config;
  return /* @__PURE__ */ react.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ react.createElement(
      ...
      content.items.map((item, index) => /* @__PURE__ */ react.createElement(
        "div",
        {
          key: index,
          style: {
    ...
    content.summary && /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          marginTop: "60px",
...
;// ./src/templates/Comparison.tsx

const ComparisonTemplate = ({ config }) => {
  var _a, _b;
  const { content, style } = config;
  return /* @__PURE__ */ react.createElement(
    "div",
    ...
    /* @__PURE__ */ react.createElement(
      ...
      content.subtitle && /* @__PURE__ */ react.createElement(
        "h2",
        {
          style: {
            fontSize: "20px",
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement("span", { style: { fontSize: "40px", marginRight: "10px" } }, content.left_icon),
          /* @__PURE__ */ react.createElement(
            "h3",
            {
              style: {
        ...
        /* @__PURE__ */ react.createElement("div", { style: { flex: 1 } }, (_a = content.left_items) == null ? void 0 : _a.map((item, index) => /* @__PURE__ */ react.createElement(
          "div",
          {
            key: index,
            style: {
          ...
          /* @__PURE__ */ react.createElement("span", { style: { fontSize: "32px", marginRight: "10px" } }, item.icon),
      ...
      /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement("span", { style: { fontSize: "40px", marginRight: "10px" } }, content.right_icon),
          /* @__PURE__ */ react.createElement(
            "h3",
            {
              style: {
        ...
        /* @__PURE__ */ react.createElement("div", { style: { flex: 1 } }, (_b = content.right_items) == null ? void 0 : _b.map((item, index) => /* @__PURE__ */ react.createElement(
          "div",
          {
            key: index,
            style: {
...
const Infographic = ({ config }) => {
  var _a, _b;
  const width = ((_a = config.output) == null ? void 0 : _a.width) || 1920;
  const height = ((_b = config.output) == null ? void 0 : _b.height) || 1080;
  const renderTemplate = () => {
    switch (config.template) {
      case "knowledge":
        return /* @__PURE__ */ react.createElement(KnowledgeTemplate, { config });
      case "xiaohongshu":
        return /* @__PURE__ */ react.createElement(XiaohongshuTemplate, { config });
      case "comparison":
        return /* @__PURE__ */ react.createElement(ComparisonTemplate, { config });
      default:
        return /* @__PURE__ */ react.createElement(KnowledgeTemplate, { config });
    }
  };
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: config.style.background_color } }, renderTemplate());
};
...
var Scheduler = __webpack_require__(1434),
  React = __webpack_require__(3696),
  ReactDOM = __webpack_require__(8325);
...
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2053);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(424);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2540);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(113), __webpack_require__.e(494)]).then(__webpack_require__.bind(__webpack_require__, 8113)).then(({ StudioInternals }) => {
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8325);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "infographic-generator-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkinfographic_generator_remotion"] = self["webpackChunkinfographic_generator_remotion"] || [];
